...
do for [alg in "MergeSort QuickSort\_v1 QuickSort\_v2 QuickSort\_v3"] {
        ...
        fit f2(x) 'data/'.alg.'_'.num_min.'-'.num_max.'_incr'.incr.'_per'.perm.'.log' using 1:3 via k
...
fit fq2(x) 'worst_data/Quicksort_v2_'.num_min.'-'.num_max.'_incr'.incr.'_with_worst_Quicksort_v2.log' using 1:3 via kq2
fit fq3(x) 'worst_data/Quicksort_v3_'.num_min.'-'.num_max.'_incr'.incr.'_with_worst_Quicksort_v3.log' using 1:3 via kq3
...
fit fq2(x) 'worst_data/Quicksort_v2_'.num_min.'-'.num_max.'_incr'.incr.'_with_worst_Quicksort_v2.log' using 1:2 via kq2
fit fq3(x) 'worst_data/Quicksort_v3_'.num_min.'-'.num_max.'_incr'.incr.'_with_worst_Quicksort_v3.log' using 1:2 via kq3
...
fq2(x) = kq2 * x * log(x) / log(2)
fq3(x) = kq3 * x * log(x) / log(2)
fit fm(x) 'worst_data/MergeSort_'.num_min.'-'.num_max.'_incr'.incr.'_with_worst_'.alg.'.log' using 1:3 via km
fit fq1(x) 'worst_data/Quicksort_v1_'.num_min.'-'.num_max.'_incr'.incr.'_with_worst_'.alg.'.log' using 1:3 via kq1
fit fq2(x) 'worst_data/Quicksort_v2_'.num_min.'-'.num_max.'_incr'.incr.'_with_worst_'.alg.'.log' using 1:3 via kq2
fit fq3(x) 'worst_data/Quicksort_v3_'.num_min.'-'.num_max.'_incr'.incr.'_with_worst_'.alg.'.log' using 1:3 via kq3
...
do for [alg in "QuickSort\_v2 QuickSort\_v3"]{
...
fq2(x) = kq2 * x * log(x) / log(2)
fq3(x) = kq3 * x * log(x) / log(2)
fit fm(x) 'worst_data/MergeSort_'.num_min.'-'.num_max.'_incr'.incr.'_with_worst_'.alg.'.log' using 1:2 via km
fit fq1(x) 'worst_data/Quicksort_v1_'.num_min.'-'.num_max.'_incr'.incr.'_with_worst_'.alg.'.log' using 1:2 via kq1
fit fq2(x) 'worst_data/Quicksort_v2_'.num_min.'-'.num_max.'_incr'.incr.'_with_worst_'.alg.'.log' using 1:2 via kq2
fit fq3(x) 'worst_data/Quicksort_v3_'.num_min.'-'.num_max.'_incr'.incr.'_with_worst_'.alg.'.log' using 1:2 via kq3
...
fq3(x) = kq3 * x * log(x) / log(2)
fit fm(x) 'worst_data/MergeSort_pot'.pot_min.'-pot'.pot_max.'_with_worst_Mergesort.log' using 1:3 via km
fit fq1(x) 'worst_data/Quicksort_v1_pot'.pot_min.'-pot'.pot_max.'_with_worst_Mergesort.log' using 1:3 via kq1
fit fq2(x) 'worst_data/Quicksort_v2_pot'.pot_min.'-pot'.pot_max.'_with_worst_Mergesort.log' using 1:3 via kq2
fit fq3(x) 'worst_data/Quicksort_v3_pot'.pot_min.'-pot'.pot_max.'_with_worst_Mergesort.log' using 1:3 via kq3
...
fq3(x) = kq3 * x * log(x) / log(2)
fit fm(x) 'worst_data/MergeSort_pot'.pot_min.'-pot'.pot_max.'_with_worst_Mergesort.log' using 1:2 via km
fit fq1(x) 'worst_data/Quicksort_v1_pot'.pot_min.'-pot'.pot_max.'_with_worst_Mergesort.log' using 1:2 via kq1
fit fq2(x) 'worst_data/Quicksort_v2_pot'.pot_min.'-pot'.pot_max.'_with_worst_Mergesort.log' using 1:2 via kq2
fit fq3(x) 'worst_data/Quicksort_v3_pot'.pot_min.'-pot'.pot_max.'_with_worst_Mergesort.log' using 1:2 via kq3

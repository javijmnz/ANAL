...
int main(int argc, char** argv)
{
  ...
  sprintf(nombreFichero, "single/stats/%s_%d-%d_incr%d_worst.log", nombresAlgoritmos[numfunc], num_min, num_max, incr);

  /* compute times */
  ret = generate_sorting_times_quicksort_worst(func[numfunc], nombreFichero, num_min, num_max, incr);

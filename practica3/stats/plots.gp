...
set terminal png size 1000,1000
set output 'graph/comp_lin_auto_search_'.num_min.'-'.num_max.'_incr'.incr.'_avg_ob.png'
set title "Comparación busqueda lineal autoorganizada\n".'Caso Medio (incr = '.incr.')'."\n".sprintf("n times = 1 -> %.2f*logn \n", k1).sprintf("n times = 10 -> %.2f*logn \n", k2).sprintf("n times = 100 -> %.2f*log n \n", k3).sprintf("n times = 1000 -> %.2f*log n \n", k4)
...
fit f1(x) 'data/bin_search_key_gen_pot_'.num_min.'-'.num_max.'_incr'.incr.'_n_times1.log' using 1:3 via k1
fit f2(x) 'data/bin_search_key_gen_unif_'.num_min.'-'.num_max.'_incr'.incr.'_n_times1.log' using 1:3 via k2
set terminal png size 1000,1000
...
plot    'data/bin_search_key_gen_pot_'.num_min.'-'.num_max.'_incr'.incr.'_n_times1.log' using 1:3 title 'uniforme' with l, \
        'data/bin_search_key_gen_unif_'.num_min.'-'.num_max.'_incr'.incr.'_n_times1.log' using 1:3 title 'potencial' with l
...
plot    'data/lin_search_key_gen_pot_'.num_min.'-'.num_max.'_incr'.incr.'_n_times1.log' using 1:3 title 'uniforme' with l, \
        'data/lin_search_key_gen_unif_'.num_min.'-'.num_max.'_incr'.incr.'_n_times1.log' using 1:3 title 'potencial' with l
